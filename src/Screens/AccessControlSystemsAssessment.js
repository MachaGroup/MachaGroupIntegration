  ...
  return (
    <div className="form-page">
        <header className="header">
          ...
          <h1>7.1.2.2.2. Access Control Systems Assessment</h1>
          <img src={logo} alt="Logo" className="logo" />
        </header>

        <main className="form-container">
            <form onSubmit={handleSubmit}>
                {/* 7.1.2.2.2. Access Control Systems Assessment */}
                <h2>7.1.2.2.2. Access Control Systems Assessment:</h2>
...
export default AccessControlSystemsAssessmentFormPage;