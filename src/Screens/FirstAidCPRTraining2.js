  ...
  <main className="form-container">
    <form onSubmit={handleSubmit}>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="trainingEffectivenessEvaluation" placeholder="Describe the effectiveness" onChange={handleChange}/>
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="trainingOutcomesMeasurement" value="yes" onChange={handleChange}/> Yes
          <input type="radio" name="trainingOutcomesMeasurement" value="no" onChange={handleChange}/> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="trainingFrequency" placeholder="Describe the frequency" onChange={handleChange}/>
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="recertificationSchedules" value="yes" onChange={handleChange}/> Yes
          <input type="radio" name="recertificationSchedules" value="no" onChange={handleChange}/> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="trainingIntegration" placeholder="Describe how they're integrated" onChange={handleChange}/>
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="standardizedProtocolsTraining" value="yes" onChange={handleChange}/> Yes
          <input type="radio" name="standardizedProtocolsTraining" value="no" onChange={handleChange}/> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="trainingResources" placeholder="Describe the resources/materials/training aids" onChange={handleChange}/>
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="accessibleTrainingResources" value="yes" onChange={handleChange}/> Yes
          <input type="radio" name="accessibleTrainingResources" value="no" onChange={handleChange}/> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="trainingDeliveryMethods" placeholder="Describe how they're delivered" onChange={handleChange}/>
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="certifiedInstructorFacilitation" value="yes" onChange={handleChange}/> Yes
          <input type="radio" name="certifiedInstructorFacilitation" value="no" onChange={handleChange}/> No
        </div>
      </div>
