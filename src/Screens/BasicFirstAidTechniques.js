...
function BasicFirstAidTechniquesFormPage() {
  ...
  return (
    ...
    <header className="header">
      ...
      <h1>3.1.1.2.5 Basic First Aid Techniques Assessment</h1>
    ...
    <main className="form-container">
      <form onSubmit={handleSubmit}>
        ...
        <h2>3.1.1.2.5.1 Curriculum Coverage and Depth:</h2>
        <div className="form-section">
          ...
          <div>
            <input type="text" name="first-aid-comprehensiveness" placeholder="Describe how it's comprehensive" onChange={handleChange} />
          </div>
        </div>
