    ...
    <main className="form-container">
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="text" name="firstAidComprehensiveness" placeholder="Describe how it's comprehensive" onChange={handleChange}/>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="radio" name="trainingModulesStructure" value="yes" onChange={handleChange}/> Yes
            <input type="radio" name="trainingModulesStructure" value="no" onChange={handleChange}/> No
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="text" name="firstDidMaterialsCoverage" placeholder="Describe how it addresses the techniques" onChange={handleChange}/>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="radio" name="emergencyRecognitionTraining" value="yes" onChange={handleChange}/> Yes
            <input type="radio" name="emergencyRecognitionTraining" value="no" onChange={handleChange}/> No
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="text" name="firstAidProficiencyAssessment" placeholder="Describe how they're assessed/evaluated" onChange={handleChange}/>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="text" name="skillsPracticeOpportunities" placeholder="Describe the opportunities" onChange={handleChange}/>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="radio" name="handsOnPropsUsage" value="yes" onChange={handleChange}/> Yes
            <input type="radio" name="handsOnPropsUsage" value="no" onChange={handleChange}/> No
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="text" name="instructorGuidance" placeholder="Describe how they're guided/supported" onChange={handleChange}/>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="radio" name="skillsFeedback" value="yes" onChange={handleChange}/> Yes
            <input type="radio" name="skillsFeedback" value="no" onChange={handleChange}/> No
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="text" name="learningReinforcementMechanisms" placeholder="Describe the mechanisms" onChange={handleChange}/>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="text" name="firstAidIntegration" placeholder="Describe how they're integrated" onChange={handleChange}/>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="radio" name="lifeThreateningPriorityTraining" value="yes" onChange={handleChange}/> Yes
            <input type="radio" name="lifeThreateningPriorityTraining" value="no" onChange={handleChange}/> No
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="text" name="responderCoordination" placeholder="Describe how they're coordinated/communicate" onChange={handleChange}/>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="text" name="continuityOfCareProvisions" placeholder="Describe the provisions" onChange={handleChange}/>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="radio" name="firstAidDocumentationTraining" value="yes" onChange={handleChange}/> Yes
            <input type="radio" name="firstAidDocumentationTraining" value="no" onChange={handleChange}/> No
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="text" name="postAidManagement" placeholder="Describe how they're managed" onChange={handleChange}/>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="text" name="careTransferProcedures" placeholder="Describe the procedures" onChange={handleChange}/>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="radio" name="emotionalSupportTraining" value="yes" onChange={handleChange}/> Yes
            <input type="radio" name="emotionalSupportTraining" value="no" onChange={handleChange}/> No
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="text" name="followUpProcedures" placeholder="Describe how they're implemented" onChange={handleChange}/>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="radio" name="communityResourcesAwareness" value="yes" onChange={handleChange}/> Yes
            <input type="radio" name="communityResourcesAwareness" value="no" onChange={handleChange}/> No
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="text" name="aidInterventionDocumentation" placeholder="Describe how they're documented" onChange={handleChange}/>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="text" name="documentationGuidance" placeholder="Describe the training/guidance" onChange={handleChange}/>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="radio" name="clearDocumentationTraining" value="yes" onChange={handleChange}/> Yes
            <input type="radio" name="clearDocumentationTraining" value="no" onChange={handleChange}/> No
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="text" name="recordAnalysis" placeholder="Describe how they are reviewed and analyzed" onChange={handleChange}/>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div>
            <input type="radio" name="documentationResponsibilityAwareness" value="yes" onChange={handleChange}/> Yes
            <input type="radio" name="documentationResponsibilityAwareness" value="no" onChange={handleChange}/> No
          </div>
        </div>
