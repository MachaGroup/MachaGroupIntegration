...
function BullyingPreventionPage() {
  ...
  return (
    <div className="form-page">
      ...
      <main className="form-container">
        ...
        <form>
          {/* Bullying Prevention Buttons */}
          {['Recognizing Bullying Behavior', 'Reporting Procedures'].map((section, index) => (
...
export default BullyingPreventionPage;