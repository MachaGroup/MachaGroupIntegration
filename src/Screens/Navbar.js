  ...
  const sections = [
    ...
    },
    {
      ...
      subsections: [
        ...
        { name: "Communication Platforms", path: "/CommunicationPlatforms" },
        { name: "Parent Notification Procedures", path: "/ParentNotificationProcedures" },
        { name: "Communication Language", path: "/CommunicationLanguage" },
      ],
    },
    {
      ...
      subsections: [
        ...
        { name: "Response Protocols", path: "/ResponseProtocols" },
