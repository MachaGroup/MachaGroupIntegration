        ...
        <main className="form-container">
            <form>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="access-rights" placeholder="Describe how they prioritize" />  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="access-rights" placeholder="Describe the decision-making" />  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="access-rights" placeholder="Describe how they're initiated" />  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="access-rights" placeholder="Describe how they're utizlized" />  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="access-rights" placeholder="Describe how they facilitate" />  
                    </div>
                </div>
