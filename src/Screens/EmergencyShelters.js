            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-section">
                    ...
                    <div>
                        ...
                        <textarea className='comment-box' name="emergencyDrillsComment" placeholder="Comment (Optional)" onChange={handleChange}></textarea>
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        ...
                        <textarea className='comment-box' name="shelterAwarenessOutreachComment" placeholder="Comment (Optional)" onChange={handleChange}></textarea>
                    </div>
                </div>
