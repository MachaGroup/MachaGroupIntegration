    ...
    <div className="form-page">
      ...
      <main className="form-container">
        <form onSubmit={handleSubmit}>
          ...
          <h2>4.3.1.2.1.1 Reporting Mechanisms and Accessibility:</h2>
          ...
          <h2>4.3.1.2.1.2 Training and Awareness on Reporting:</h2>
          <div className="form-section">
          ...
          <h2>4.3.1.2.1.3 Response and Follow-Up:</h2>
          <div className="form-section">
          ...
          <h2>4.3.1.2.1.4 Effectiveness and Improvement:</h2>
          <div className="form-section">
          ...
          <h2>4.3.1.2.1.5 Integration with Broader Security Practices:</h2>
          <div className="form-section">
          ...
          <h2>4.3.1.2.1.6 Encouraging a Reporting Culture:</h2>
          <div className="form-section">
          ...
          <h2>4.3.1.2.1.7 Technology and Automation:</h2>
          <div className="form-section">
          ...
          <h2>4.3.1.2.1.8 Communication and Feedback:</h2>
          <div className="form-section">
