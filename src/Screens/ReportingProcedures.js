...
function ReportingProceduresPage() {
    ...
    <div className="form-page">
      ...
      <main className="form-container">
        ...
        <form>
          ...
          {['Trusted Adults', 'Anonymous Reporting Systems', 'Peer Support Networks'].map((section, index) => (
...
export default ReportingProceduresPage;