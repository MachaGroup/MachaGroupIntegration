...
function IdentifyingSuspiciousBehaviorFormPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formsRef = collection(db, 'forms/Personnel Training and Awareness/Identifying Suspicious Behavior');
        ...
        <main className="form-container">
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="radio" name="suspiciousBehaviorTraining" value="yes" onChange={handleChange}/> Yes
                        <input type="radio" name="suspiciousBehaviorTraining" value="no" onChange={handleChange}/> No
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="suspiciousBehaviors" placeholder="Describe the behaviors/actions" onChange={handleChange}/>  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="vigilanceEducation" placeholder="Describe how they're educated" onChange={handleChange}/>  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="radio" name="reportingProcedures" value="yes" onChange={handleChange}/> Yes
                        <input type="radio" name="reportingProcedures" value="no" onChange={handleChange}/> No
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="reportingTraining" placeholder="Describe how they're trained" onChange={handleChange}/>  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="confidentialityMeasures" placeholder="Describe the measures" onChange={handleChange}/>  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="communicationEncouragement" placeholder="Describe how they're encouraged" onChange={handleChange}/>  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="informationSharing" placeholder="Describe the mechanisms" onChange={handleChange}/>  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="threatAssessmentProtocols" placeholder="Describe the protocols" onChange={handleChange}/>  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="radio" name="scenarioTraining" value="yes" onChange={handleChange}/> Yes
                        <input type="radio" name="scenarioTraining" value="no" onChange={handleChange}/> No
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="scenarioSimulation" placeholder="Describe how they simulate" onChange={handleChange}/>  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="biasAwareness" placeholder="Describe the mechanisms" onChange={handleChange}/>  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="culturalSensitivity" placeholder="Describe how they promote these" onChange={handleChange}/>  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="dialogueStrategies" placeholder="Describe the strategies" onChange={handleChange}/>  
                    </div>
                </div>
