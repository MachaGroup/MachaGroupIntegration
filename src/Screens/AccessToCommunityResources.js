...
function AccessToCommunityResourcesPage() {
  ...
  return (
    <div className="form-page">
      ...
      {/* Access to Community Resources Section */}
      <main className="form-container">
        <h2>Access to Community Resources</h2>
        <form>
          {/* Access to Community Resources Buttons */}
          {['Emergency Shelters', 'Medical Facilities', 'Mental Health Services'].map((section, index) => (
