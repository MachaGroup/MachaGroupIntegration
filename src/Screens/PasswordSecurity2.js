...
function PasswordSecurity2FormPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formsRef = collection(db, 'forms/Personnel Training and Awareness/Password Security 2');
        ...
        <main className="form-container">
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="radio" name="creating-strong-passwords" value="yes" onChange={handleChange} /> Yes
                        <input type="radio" name="creating-strong-passwords" value="no" onChange={handleChange} /> No
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="selecting-secure-passwords" placeholder="Describe the guidelines/criteria" onChange={handleChange} />  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="access-rights" placeholder="Describe how they're educated" onChange={handleChange} />  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="access-rights" placeholder="Describe the resources/materials" onChange={handleChange} />  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="access-rights" placeholder="Describe how they're encouraged" onChange={handleChange} />  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="access-rights" placeholder="Describe how they're reminded" onChange={handleChange} />  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="access-rights" placeholder="Describe how they're monitored" onChange={handleChange} />  
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        <input type="text" name="access-rights" placeholder="Describe the strategies" onChange={handleChange} />  
                    </div>
                </div>
