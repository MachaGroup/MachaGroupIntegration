...
function PublicAddressSystemPage() {
  ...
  return (
    <div className="form-page">
      ...
      <main className="form-container">
        ...
        <form>
          {/* Public Address System Buttons */}
          {['Speaker Locations', 'Emergency Announcement Protocols', 'Backup Power Systems'].map((section, index) => (
...
export default PublicAddressSystemPage;