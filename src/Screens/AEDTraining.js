  ...
  <main className="form-container">
    <form>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="aed-familiarity" placeholder="Describe how familiar they are" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="aed-strategic-positioning" value="yes" /> Yes
          <input type="radio" name="aed-strategic-positioning" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="aed-availability-measures" placeholder="Describe the measures" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="aed-training-topics" placeholder="List the topics/skills" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="aed-training-alignment" value="yes" /> Yes
          <input type="radio" name="aed-training-alignment" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="aed-training-key-concepts" placeholder="Describe how they address concepts" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="aed-practice-sessions" placeholder="Describe the sessions" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="aed-practice-opportunities" value="yes" /> Yes
          <input type="radio" name="aed-practice-opportunities" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="aed-simulation-scenarios" placeholder="Describe the simulations" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="aed-maintenance-procedures" placeholder="Describe the procedures" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="aed-maintenance-training" value="yes" /> Yes
          <input type="radio" name="aed-maintenance-training" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="aed-maintenance-records" placeholder="Describe how they're monitored/documented" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="aed-protocol-integration" placeholder="Describe how they're integrated" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="sudden-cardiac-response-training" value="yes" /> Yes
          <input type="radio" name="sudden-cardiac-response-training" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="aed-coordination-mechanisms" placeholder="Describe the mechanisms" />
        </div>
      </div>
    </form>
  </main>
