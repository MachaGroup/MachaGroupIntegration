      ...
      <main className="form-container">
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-section">
            ...
            <div>
              <input type="text" name="aedFamiliarity" placeholder="Describe how familiar they are" onChange={handleChange}/>
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div>
              <input type="radio" name="aedStrategicPositioning" value="yes" onChange={handleChange}/> Yes
              <input type="radio" name="aedStrategicPositioning" value="no" onChange={handleChange}/> No
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div>
              <input type="text" name="aedAvailabilityMeasures" placeholder="Describe the measures" onChange={handleChange}/>
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div>
              <input type="text" name="aedTrainingTopics" placeholder="List the topics/skills" onChange={handleChange}/>
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div>
              <input type="radio" name="aedTrainingAlignment" value="yes" onChange={handleChange}/> Yes
              <input type="radio" name="aedTrainingAlignment" value="no" onChange={handleChange}/> No
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div>
              <input type="text" name="aedTrainingKeyConcepts" placeholder="Describe how they address concepts" onChange={handleChange}/>
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div>
              <input type="text" name="aedPracticeSessions" placeholder="Describe the sessions" onChange={handleChange}/>
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div>
              <input type="radio" name="aedPracticeOpportunities" value="yes" onChange={handleChange}/> Yes
              <input type="radio" name="aedPracticeOpportunities" value="no" onChange={handleChange}/> No
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div>
              <input type="text" name="aedSimulationScenarios" placeholder="Describe the simulations" onChange={handleChange}/>
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div>
              <input type="text" name="aedMaintenanceProcedures" placeholder="Describe the procedures" onChange={handleChange}/>
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div>
              <input type="radio" name="aedMaintenanceTraining" value="yes" onChange={handleChange}/> Yes
              <input type="radio" name="aedMaintenanceTraining" value="no" onChange={handleChange}/> No
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div>
              <input type="text" name="aedMaintenanceRecords" placeholder="Describe how they're monitored/documented" onChange={handleChange}/>
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div>
              <input type="text" name="aedProtocolIntegration" placeholder="Describe how they're integrated" onChange={handleChange}/>
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div>
              <input type="radio" name="suddenCardiacResponseTraining" value="yes" onChange={handleChange}/> Yes
              <input type="radio" name="suddenCardiacResponseTraining" value="no" onChange={handleChange}/> No
            </div>
          </div>
          ...
          <div className="form-section">
            ...
            <div>
              <input type="text" name="aedCoordinationMechanisms" placeholder="Describe the mechanisms" onChange={handleChange}/>
            </div>
          </div>
