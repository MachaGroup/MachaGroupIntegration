            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-section">
                    ...
                    <div>
                        ...
                        <textarea className='comment-box' name="peerSupportProgramsComment" placeholder="Comment (Optional)" onChange={handleChange}></textarea>
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        ...
                        <textarea className='comment-box' name="restorativeJusticeComment" placeholder="Comment (Optional)" onChange={handleChange}></textarea>
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div>
                        ...
                        <textarea className='comment-box' name="communityCollaborationComment" placeholder="Comment (Optional)" onChange={handleChange}></textarea>
                    </div>
                </div>
